...
func (v *VideoService) Finish() error {
	...
	if err != nil {
		log.Println("Error while removing video: ", v.Video.ID, ".mp4")
		return err
	}
	...
	if err != nil {
		log.Println("Error while removing video frag: ", v.Video.ID, ".frag")
		return err
	}
	...
	if err != nil {
		log.Println("Error while removing video directory", v.Video.ID)
		return err
	}
